...
namespace graphslam
{
  ...
  : Node("robot_centric_slam", options),
    clock_(RCL_ROS_TIME),
  ...
  void GraphBasedSlamComponent::initializePubSub()
  {
    ...
    auto map_array_callback =
      [this](const typename vox_nav_slam_msgs::msg::MapArray::SharedPtr msg_ptr) -> void
      {
    ...
    map_array_sub_ =
      create_subscription<vox_nav_slam_msgs::msg::MapArray>(
    ...
    modified_map_array_pub_ = create_publisher<vox_nav_slam_msgs::msg::MapArray>(
  ...
  void GraphBasedSlamComponent::searchLoop()
  {
    ...
    vox_nav_slam_msgs::msg::MapArray map_array_msg = map_array_msg_;
    std::lock_guard<std::mutex> lock(mtx_);
    ...
    vox_nav_slam_msgs::msg::SubMap latest_submap;
    ...
    vox_nav_slam_msgs::msg::SubMap min_submap;
  ...
  void GraphBasedSlamComponent::doPoseAdjustment(
    vox_nav_slam_msgs::msg::MapArray map_array_msg,
    bool do_save_map)
  {
